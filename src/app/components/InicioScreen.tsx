    ...
    <div className="flex-1 overflow-y-auto bg-white pb-4 sm:pb-6">
      ...
      <div className="relative bg-gradient-to-b from-[#c8006a] to-[#9a0052] px-4 pt-10 pb-14 sm:px-6 sm:pt-12 sm:pb-16 lg:px-8">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <h1 className="text-white text-2xl capitalize mt-0.5" style={{ fontFamily: "'Open Sans', sans-serif" }}>
            {userName}
          </h1>
        </motion.div>
      ...
      <div className="px-4 sm:px-5 lg:px-6 -mt-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-3 mt-4 pt-4 border-t border-[#c8006a]/10 sm:grid-cols-3">
            {[
              { value: "4",      label: "Sedes"             },
              ...
              <div key={s.label} className="text-center">
                <p className="text-[#c8006a] font-semibold" style={{ fontFamily: "'Open Sans', sans-serif" }}>{s.value}</p>
      ...
      <div className="px-5 mt-6">
        <h3 className="text-[#c8006a] mb-3" style={{ fontFamily: "'Open Sans', sans-serif" }}>Acceso rápido</h3>
      ...
      {/* Menú de hoy */}
      <div className="px-4 sm:px-5 lg:px-6 mt-6">
        <h3 className="text-[#c8006a] mb-3" style={{ fontFamily: "'Open Sans', sans-serif" }}>Menú de hoy</h3>
        <div className="bg-gradient-to-br from-[#c8006a] to-[#9a0052] rounded-2xl p-5 text-white">
          ...
          <p className="font-semibold text-lg" style={{ fontFamily: "'Open Sans', sans-serif" }}>
            Fideos con salsa bolognesa
          </p>
          <p className="text-white/60 text-xs mt-1 flex items-center gap-1"><SunMedium size={12} /> Almuerzo · Turnos 11:30 – 14:15</p>
          <div className="mt-3 pt-3 border-t border-white/20">
            ...
            <p className="text-white/60 text-xs mt-0.5 flex items-center gap-1"><MoonStar size={12} /> Retiro: 17:00 – 19:00</p>
          </div>
        </div>
      </div>

      {/* Horarios */}
      <div className="px-4 sm:px-5 lg:px-6 mt-4 mb-6">
        <div className="bg-[#fff8fc] border border-[#c8006a]/15 rounded-2xl p-5">
          <h3 className="text-[#c8006a] mb-3" style={{ fontFamily: "'Open Sans', sans-serif" }}>Horarios</h3>

          {/* Almuerzo */}
          <div className="bg-white rounded-xl p-3 shadow-sm mb-3">
            <div className="flex items-center gap-2 mb-2">
              <SunMedium size={18} className="text-[#c8006a]" />
          ...
          <div className="bg-white rounded-xl p-3 shadow-sm">
            <div className="flex items-center gap-2 mb-1">
              <MoonStar size={18} className="text-[#c8006a]" />
